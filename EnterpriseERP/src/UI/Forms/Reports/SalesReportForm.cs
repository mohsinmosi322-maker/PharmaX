...
namespace EnterpriseERP.UI.Forms.Reports
{
    public partial class SalesReportForm : Form
    {
        ...
        private Label lblFrom, lblTo, lblCustomer, lblProduct;
        private GroupBox grpFilters;

        public SalesReportForm(IReportingService reportingService)
        {
        ...
        private void InitializeComponent()
        {
            ...
            lblCustomer = new Label { Text = "Customer:", Location = new System.Drawing.Point(500, 25), AutoSize = true };
            cmbCustomer = new ComboBox { Location = new System.Drawing.Point(570, 22), Width = 200, DropDownStyle = ComboBoxStyle.DropDownList };
            ...
            grpFilters.Controls.AddRange(new Control[] {
                ...
                lblCustomer, cmbCustomer, lblProduct, cmbProduct,
            ...
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "SaleDate", HeaderText = "Date", Width = 100 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "InvoiceNumber", HeaderText = "Invoice #", Width = 120 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "CustomerName", HeaderText = "Customer", Width = 150 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "ProductCode", HeaderText = "Code", Width = 80 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "ProductName", HeaderText = "Product", Width = 180 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "BatchNumber", HeaderText = "Batch", Width = 90 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "Quantity", HeaderText = "Qty", Width = 70 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "UnitPrice", HeaderText = "Unit Price", Width = 90 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "Discount", HeaderText = "Discount", Width = 80 });
            dgvSales.Columns.Add(new DataGridViewTextBoxColumn { Name = "TotalAmount", HeaderText = "Total", Width = 100 });
            ...
            {
                Text = "Total Sales: 0 | Total Quantity: 0",
            ...
            this.Controls.AddRange(new Control[] { grpFilters, dgvSales, pnlSummary });
        }
        ...
        private void BtnLoad_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int customerId = cmbCustomer.SelectedValue != null ? Convert.ToInt32(cmbCustomer.SelectedValue) : 0;
                int productId = cmbProduct.SelectedValue != null ? Convert.ToInt32(cmbProduct.SelectedValue) : 0;

                var reportData = _reportingService.GetSalesReport(fromDate, toDate, customerId, productId);
                
                dgvSales.DataSource = reportData;
                ...
                if (pnl != null)
                {
                    ...
                    if (lbl != null)
                    {
                        lbl.Text = $"Total Sales: {totalSales:N2} | Total Quantity: {totalQty:N0}";
                    }
                }
                ...
                {
                    if (col.Name == "UnitPrice" || col.Name == "Discount" || col.Name == "TotalAmount")
                    {
        ...
        private void BtnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SaveFileDialog saveFileDialog = new SaveFileDialog
                {
                    ...
                    FileName = $"Sales_Report_{DateTime.Now:yyyyMMdd_HHmmss}"
                };
